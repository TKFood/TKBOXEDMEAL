...
{
    public partial class frmREPORTLOCAL : Form
    {
        ...
        public StringBuilder SETsbSql()
        {
            ...
            if (comboBox1.Text.ToString().Equals("便當統計"))
            {
                ...
                STR.Append(@" FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER],[TKBOXEDMEAL].[dbo].[MEAL],[TKBOXEDMEAL].[dbo].[MEALDISH] ");
                STR.Append(@" WHERE [LOCALEMPORDER].[MEAL]=[MEAL].[MEAL] AND [LOCALEMPORDER].[DISH]=[MEALDISH].[DISH]");
            ...
            {
                STR.AppendFormat(@"  SELECT [Department].[Name],[ID] AS '工號' ,[LOCALEMPORDER].[NAME] AS '姓名',[CARDNO] AS '卡號'");
                STR.AppendFormat(@"  ,CONVERT(varchar(10),[LOCALEMPORDER].[DATE],112) AS '日期',[MEAL].[MEALNAME] AS '午晚餐'");
                STR.AppendFormat(@"  ,[MEALDISH].[DISHNAME] AS '葷素',[NUM] AS '訂餐量',[EATNUM] AS '用餐量'");
                STR.AppendFormat(@"  FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER],[TKBOXEDMEAL].[dbo].[MEAL],[TKBOXEDMEAL].[dbo].[MEALDISH],[HRMDB].[dbo].[Employee],[HRMDB].[dbo].[Department] ");
                STR.AppendFormat(@"  WHERE [Employee].[Code]=[LOCALEMPORDER].[ID] COLLATE Chinese_Taiwan_Stroke_BIN");
                STR.AppendFormat(@"  AND [Employee].DepartmentId=[Department] .DepartmentId");
                STR.AppendFormat(@"  AND [LOCALEMPORDER].[MEAL]=[MEAL].[MEAL] AND [LOCALEMPORDER].[DISH]=[MEALDISH].[DISH]  ");
                STR.AppendFormat(@"  AND CONVERT(varchar(10),[LOCALEMPORDER].[DATE],112)='{0}' ", dateTimePicker1.Value.ToString("yyyyMMdd"));
                STR.AppendFormat(@"  ORDER BY  CONVERT(varchar(10),[LOCALEMPORDER].[DATE],112),[Department].[Name],[MEAL].[MEALNAME],[MEALDISH].[DISHNAME],[ID]");
                STR.AppendFormat(@"  ");
            ...
            else if (comboBox1.Text.ToString().Equals("部門訂餐統計-午餐"))
            {
                ...
                STR.AppendFormat(@"  AND [LOCALEMPORDER].[MEAL]=[MEAL].[MEAL] AND [LOCALEMPORDER].[DISH]=[MEALDISH].[DISH]  ");
                STR.AppendFormat(@"  AND CONVERT(varchar(10),[LOCALEMPORDER].[DATE],112)='{0}' ", dateTimePicker1.Value.ToString("yyyyMMdd"));
                STR.AppendFormat(@"  AND [LOCALEMPORDER].[MEAL]='10' ");
                STR.AppendFormat(@"  ORDER BY  CONVERT(varchar(10),[LOCALEMPORDER].[DATE],112),[Department].[Name],[MEAL].[MEALNAME],[MEALDISH].[DISHNAME],[ID]");
                STR.AppendFormat(@"  ");
            ...
            else if (comboBox1.Text.ToString().Equals("部門訂餐統計-晚餐"))
            {
                ...
                STR.AppendFormat(@"  AND [LOCALEMPORDER].[MEAL]=[MEAL].[MEAL] AND [LOCALEMPORDER].[DISH]=[MEALDISH].[DISH]  ");
                STR.AppendFormat(@"  AND CONVERT(varchar(10),[LOCALEMPORDER].[DATE],112)='{0}' ", dateTimePicker1.Value.ToString("yyyyMMdd"));
                STR.AppendFormat(@"  AND [LOCALEMPORDER].[MEAL]='20' ");
                STR.AppendFormat(@"  ORDER BY  CONVERT(varchar(10),[LOCALEMPORDER].[DATE],112),[Department].[Name],[MEAL].[MEALNAME],[MEALDISH].[DISHNAME],[ID]");
                STR.AppendFormat(@"  ");
            ...
            else if (comboBox1.Text.ToString().Equals("有上班未訂餐查詢"))
            {
                ...
                STR.AppendFormat(@"  AND NOT  EXISTS (SELECT ID FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] WHERE CONVERT(varchar(100),[DATE],112)=CONVERT(varchar(100),[AttendanceRollcall].[Date],112) AND ID=[Employee].[Code] COLLATE Chinese_PRC_CI_AS) ");
            ...
            else if (comboBox1.Text.ToString().Equals("每月統計"))
            {
                ...
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'26%' AND [MEAL]='10'),0) AS '26-中餐'", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'27%' AND [MEAL]='10'),0) AS '27-中餐'", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'28%' AND [MEAL]='10'),0) AS '28-中餐'", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'29%' AND [MEAL]='10'),0) AS '29-中餐' ", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'30%' AND [MEAL]='10'),0) AS '30-中餐'", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'31%' AND [MEAL]='10'),0) AS '31-中餐'", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'01%' AND [MEAL]='10'),0) AS '01-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'02%' AND [MEAL]='10'),0) AS '02-中餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'03%' AND [MEAL]='10'),0) AS '03-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'04%' AND [MEAL]='10'),0) AS '04-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'05%' AND [MEAL]='10'),0) AS '05-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'06%' AND [MEAL]='10'),0) AS '06-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'07%' AND [MEAL]='10'),0) AS '07-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'08%' AND [MEAL]='10'),0) AS '08-中餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'09%' AND [MEAL]='10'),0) AS '09-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'10%' AND [MEAL]='10'),0) AS '10-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'11%' AND [MEAL]='10'),0) AS '11-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'12%' AND [MEAL]='10'),0) AS '12-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'13%' AND [MEAL]='10'),0) AS '13-中餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'14%' AND [MEAL]='10'),0) AS '14-中餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'15%' AND [MEAL]='10'),0) AS '15-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'16%' AND [MEAL]='10'),0) AS '16-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'17%' AND [MEAL]='10'),0) AS '17-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'18%' AND [MEAL]='10'),0) AS '18-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'19%' AND [MEAL]='10'),0) AS '19-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'20%' AND [MEAL]='10'),0) AS '20-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'21%' AND [MEAL]='10'),0) AS '21-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'22%' AND [MEAL]='10'),0) AS '22-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'23%' AND [MEAL]='10'),0) AS '23-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'24%' AND [MEAL]='10'),0) AS '24-中餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'25%' AND [MEAL]='10'),0) AS '25-中餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'26%' AND [MEAL]='20'),0) AS '26-晚餐' ", sdt1);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'27%' AND [MEAL]='20'),0) AS '27-晚餐' ", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'28%' AND [MEAL]='20'),0) AS '28-晚餐'", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'29%' AND [MEAL]='20'),0) AS '29-晚餐'", sdt1);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'30%' AND [MEAL]='20'),0) AS '30-晚餐'", sdt1);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'31%' AND [MEAL]='20'),0) AS '31-晚餐' ", sdt1);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'01%' AND [MEAL]='20'),0) AS '01-晚餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'02%' AND [MEAL]='20'),0) AS '02-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'03%' AND [MEAL]='20'),0) AS '03-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'04%' AND [MEAL]='20'),0) AS '04-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'05%' AND [MEAL]='20'),0) AS '05-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'06%' AND [MEAL]='20'),0) AS '06-晚餐'", sdt2);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'07%' AND [MEAL]='20'),0) AS '07-晚餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'08%' AND [MEAL]='20'),0) AS '08-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'09%' AND [MEAL]='20'),0) AS '09-晚餐'", sdt2);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'10%' AND [MEAL]='20'),0) AS '10-晚餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'12%' AND [MEAL]='20'),0) AS '12-晚餐'", sdt2);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'13%' AND [MEAL]='20'),0) AS '13-晚餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'14%' AND [MEAL]='20'),0) AS '14-晚餐'", sdt2);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'15%' AND [MEAL]='20'),0) AS '15-晚餐' ", sdt2);
                STR.AppendFormat(@" ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'16%' AND [MEAL]='20'),0) AS '16-晚餐' ", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'17%' AND [MEAL]='20'),0) AS '17-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'18%' AND [MEAL]='20'),0) AS '18-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'19%' AND [MEAL]='20'),0) AS '19-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'20%' AND [MEAL]='20'),0) AS '20-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'21%' AND [MEAL]='20'),0) AS '21-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'22%' AND [MEAL]='20'),0) AS '22-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'23%' AND [MEAL]='20'),0) AS '23-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'24%' AND [MEAL]='20'),0) AS '24-晚餐'", sdt2);
                STR.AppendFormat(@"  ,ISNULL((SELECT 1 FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER] EMP WHERE EMP.[ID]=[LOCALEMPORDER].[ID] AND CONVERT(varchar(100),EMP.[DATE],112) LIKE '{0}'+'25%' AND [MEAL]='20'),0) AS '25-晚餐'", sdt2);
                STR.AppendFormat(@"  FROM [TKBOXEDMEAL].[dbo].[LOCALEMPORDER]");
